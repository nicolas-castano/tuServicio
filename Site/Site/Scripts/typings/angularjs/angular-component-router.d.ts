...
declare namespace angular {
    ...
    interface Router {
        ...
        /**
         * Navigate to a URL. Returns a IPromise that resolves when navigation is complete.
        ...
        /**
         * Navigate via the provided instruction. Returns a IPromise that resolves when navigation is
         * complete.
         */
